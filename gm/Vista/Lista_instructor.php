...
<head>
    ...
    <link rel="stylesheet" href="Vista/lista_ins.css">
...
<body>
    ...
    <header>
       ...
       <div>
        <h1 class="h1h">Registro de Instructores</h1>
    </div>             
...
<div class="lcliente">
    <h2>Lista de instructores activos</h2> 
    </div>   
    <div>
        <a href="Formulario_instructor.php" class="nuevo">
    ...
    $sql = "SELECT id, apellido_paterno, apellido_materno, nombre, edad, telefono, enfermedades, turno FROM instructores";
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<td><a href='editar_instructor.php?id=" . $row["id"] . "'><i class='fa-solid fa-pen-to-square fa-fade' style='color: #000000;'></i></a></td>";
            echo "<td><a href='Eliminar_instructor.php?id=" . $row["id"] . "'><i class='fa-solid fa-trash fa-fade' style='color: #000000;'></i></a></td>";            
        }
    } else {
