...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['id']) && !empty($_POST['id'])) {
        ...
        $sql = "UPDATE instructores SET nombre='$nombre', apellido_paterno='$apellido_paterno', apellido_materno='$apellido_materno', edad='$edad', telefono='$telefono', enfermedades='$enfermedades', turno='$turno' WHERE id=$instructor_id";
        ...
        echo "ID del instructor no proporcionado.";
    }
} else {
    // Si no se recibe una solicitud POST, redirecciona a la página principal
    header("Location: Lista_instuctor.php");
    exit();
}
?>
